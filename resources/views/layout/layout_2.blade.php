...
<head>
    <title>Home | Webcoffeesite</title>
    ...
    <!-- Custom Theme files -->
    <link href="{{ asset('css/layout/bootstrap.min.css') }}" type="text/css" rel="stylesheet" media="all">
    <link href="{{ asset('css/layout/style.css') }}" type="text/css" rel="stylesheet" media="all">
    <!-- timeline -->
    <link href="{{ asset('css/layout/timeline.css') }}" type="text/css" rel="stylesheet" media="all">
    <!-- font-awesome icons -->
    <link href="{{ asset('css/layout/font-awesome.min.css') }}" rel="stylesheet">
    <!-- //Custom Theme files -->
    <!-- online-fonts -->
</head>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light navbar-fixed-top">
        <div class="container">
            <h1 class="wthree-logo">
                <a href="index.html" id="logoLink"><span>f</span>usion</a>
            </h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 bnr-txt-w3pvt  d-sm-flex justify-content-center align-items-center">
                    <div class="bnr-w3pvt-txt">
                        <h4>Hi,I'm</h4>
                        <h2>Matheus William</h2>
                        <h3>an interactive web designer with passion of creativity</h3>
                                    ...
                                    <div class="timeline-panel credits  anim animate fadeInLeft">
                                        <div class="timeline-panel-ul clearfix">
                                            <div class="lefting-wrap">
                                                <ul>
                                                    <li class="img-wraping"><a href="#"><img src="images/g4.jpg" class="img-fluid"
                                                                alt="user-image" /></a></li>
                                                </ul>
                                            </div>
                                ...
                                <div class="offset-lg-1 col-lg-12">
                                    <div class="timeline-panel debits  anim animate  fadeInRight">
                                        <div class="timeline-panel-ul clearfix">
                                            <div class="lefting-wrap">
                                                <ul>
                                                    <li class="img-wraping"><a href="#"><img src="images/g5.jpg" class="img-fluid"
                                                                alt="user-image" /></a></li>
                                                </ul>
                                            </div>
                                            <div class="righting-wrap">
                                ...
                                <div class="col-lg-12">
                                    <div class="timeline-panel credits  anim animate  fadeInLeft">
                                        <div class="timeline-panel-ul  clearfix">
                                            <div class="lefting-wrap">
                                                <ul>
                                                    <li class="img-wraping"><a href="#"><img src="images/g6.jpg" class="img-fluid"
                                                                alt="user-image" /></a></li>
                                                </ul>
                                            </div>
                                            <div class="righting-wrap">
                                ...
                                <div class="offset-lg-1 col-lg-11">
                                    <div class="timeline-panel debits  anim animate  fadeInRight">
                                        <div class="timeline-panel-ul clearfix">
                                            <div class="lefting-wrap">
                                                <ul>
                                                    <li class="img-wraping"><a href="#"><img src="images/g7.jpg" class="img-fluid"
                                                                alt="user-image" /></a></li>
                                                </ul>
                                            </div>
                                            <div class="righting-wrap">
                                ...
                                <div class="col-lg-12">
                                    <div class="timeline-panel credits  anim animate  fadeInLeft">
                                        <div class="timeline-panel-ul clearfix">
                                            <div class="lefting-wrap">
                                                <ul>
                                                    <li class="img-wraping"><a href="#"><img src="images/g8.jpg" class="img-fluid"
                                                                alt="user-image" /></a></li>
                                                </ul>
                                            </div>
                                            <div class="righting-wrap">
    ...
    <footer>
        <div class="container">
            <div class="cpy-right text-center">
                <p class="text-white">© 2018 Fusion. All rights reserved | Design by
                    <a href="http://w3layouts.com" class="text-dark font-weight-bold"> W3layouts.</a>
                </p>
            </div>
        </div>
    </footer>
    <!-- //footer -->
    <!-- js -->
    <script src="{{ asset('js/layout/jquery-2.2.3.min.js') }}"></script>
    <!-- //js -->
    <!--  menu toggle -->
    <script src="{{ asset('js/layout/menu.js') }}"></script>
    <!-- testimonials  Responsiveslides -->
    <script src="{{ asset('js/layout/responsiveslides.min.js') }}"></script>
    <script>
    ...
    <!-- //testimonials  Responsiveslides -->
    <!-- gallery -->
    <script src="{{ asset('js/layout/jquery.picEyes.js') }}"></script>
    <script>
        $(function () {
            $('.demo li').picEyes();
        });
    ...
    <script src="{{ asset('js/layout/scrolling-nav.js') }}"></script>
    <script src="{{ asset('js/layout/timeline.js') }}"></script>
    <script src="{{ asset('js/layout/move-top.js') }}"></script>
    <script src="{{ asset('js/layout/easing.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('js/layout/SmoothScroll.min.js') }}"></script>
